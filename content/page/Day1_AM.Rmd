...
cat(knitr::knit_child("../../static/modules/_example_7steps/ozone.Rmd", quiet = TRUE, envir = parent.frame()))
```
...
## Show <span style="color: #3498db;"> and </span> Tell {-}
>
...
# Help Wanted!
<hr>
```{r droid-app, child='../../static/modules/intro/droid_app/droid_application.Rmd', eval=TRUE}
```
...
<div class="well">
While BB8 tracks down data from his scrapyard friends, we'll prepare for some garbage data. Let's get to know R and RStudio. 
</div>
...
Start a new project for our analysis.
...
## Notes and comments {-}
```{r comments, child='../../static/modules/_comments.Rmd'}
```
...
```{r read_snippet, child='../../static/modules/readr/readr_load/scrap_snippet.Rmd'}
```
...
```{r order_arguments, child='../../static/modules/base/base_functions/order_arguments.Rmd'}
```


# <i class="far fa-question-circle" aria-hidden="true" style="font-size: 48px;"></i> Got questions? {-}
<hr class="hr2">
...
```{r recap, child='../../static/modules/recap/day1.Rmd'}
```
