...
<div style="width: 100%; overflow: hidden; margin-left: -110px;"> 
<div style="width: 70%; float: left; margin-top: -130px;"> 
 

<img src="../images/chewie_dance.gif" />


</div>


<div style="width: 30%; float: left; padding-left: 40px;">
