...
File paths with your user name in them don't share well with others and they also run the risk of breaking if the data is moved. It's best to store data in your project folder as much as possible to avoid using absolute paths.
