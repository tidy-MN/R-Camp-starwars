...
There's a cryptic note on the pad next to you... _"Marty's birthday"._ Could that be the hint to the passcode???

We need to determine when Marty's birthday is...time to get out our detective hats.

You ask the lead engineer: 

__So when is Marty's birthday?__
...
<div class="note">
```{r cal-plot, child='X:/Agency_Files/Outcomes/Risk_Eval_Air_Mod/_Air_Risk_Evaluation/R/R_Camp/modules/openair/calendar_plot.Rmd'}
```
</div>
