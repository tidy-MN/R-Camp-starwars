...
A single equals sign `=` is used within functions to set options, for example `read_csv(file = "scrap.csv")`. It's not a big deal if you mix them up the first time. R is often helpful and will let you know which one is needed.
</div>
