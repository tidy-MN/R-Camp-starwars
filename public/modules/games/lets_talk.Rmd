...
Instead of saying what the code does out load, act out what the code does without speaking at ALL.
...
cats_df <- read_excel("lost_cats.xlsx")

kittens <- filter(cats_df, age < 1)

catfood <- "SPAM"

hungry_kitties <- filter(kittens, hungry == TRUE)
