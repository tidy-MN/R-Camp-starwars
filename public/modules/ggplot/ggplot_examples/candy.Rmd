...
Let's launch ourselves into the unknown and make a __candy plot__. With a little copy-pasting we can make an informative chart of everyone's favorite candy. Since you obviously have the best taste, let's make your favorite candy the <span style="font-size: 26px;"> __BEST__ </span>.
...
>
> <i class="fa fa-user-astronaut" style="color:#f6cd00; margin-right: 12px;"></i>**__Explore!__**
> 
