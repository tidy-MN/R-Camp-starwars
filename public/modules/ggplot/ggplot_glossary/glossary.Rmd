...
### Table of themes {.unnumbered #theme-tbl}
...
- How do you get rid of the legend if you don't need it?
    - `geom_point(aes(color = county), guide = FALSE)`
    - The [R Cookbook](http://www.cookbook-r.com/Graphs/Legends_(ggplot2)/) shows a number of ways to hide legends.
