...
> Customize the application below to apply. The first step is picking a droid.
...
`Copy`+`paste` the code below into your script, make edits, and re-run. You know the drill.
```{r}
# Your droid bio
