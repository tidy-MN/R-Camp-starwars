...
The `Files` tab is especially handy for finding a file you want and clicking it to open it. You can also click the `More ` option and select _"Show Folder in a New Window"_ as a shortcut to open your project folder.
</div>
