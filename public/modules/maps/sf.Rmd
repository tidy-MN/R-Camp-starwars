...
That's fantastic. 
But there's one more piece of bad news. Endor uses a differnt Coordinate Reference System (CRS) than our ship.

Endor uses an outdated UTM coordinate system, but our ship requires coordinates in **WGS84 Lat/Lng**. These coordinates generally look like this `(45.6, -93.12)`. See https://epsg.io/4326 for more details.


The **SF** package will help you with coordinate conversions as well. Try using `st_transform()` and set the crs argument to: `crs = 4326`. 
