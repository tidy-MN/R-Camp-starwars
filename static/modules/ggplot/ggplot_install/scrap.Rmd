...
In data analysis you'll want to look at your data early and often. For that we use a new package called  __ggplot2__! 
...
Try another theme: `theme_classic()` or `theme_minimal()` or delete the entire line and the `+` above to see what the default settings are.
