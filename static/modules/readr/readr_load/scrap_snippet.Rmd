...
Notice the row of `<chr>` letter abbreviations under the column names? These describe the data type of each column.
...
- `<dbl>` stands for __double__. Examples: _5.000_, _3.4E-6_, _10.710_
